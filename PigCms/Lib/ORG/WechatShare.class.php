...
class WechatShare 
{
	 ...
	 * 隐藏可在微信外传播的菜单
	 */
	public function hideOutShare(){
		$this->hideMenuList =
		"['menuItem:share:qq','menuItem:share:weiboApp','menuItem:share:facebook','menuItem:share:QZone','menuItem:copyUrl','menuItem:originPage','menuItem:openWithQQBrowser',
