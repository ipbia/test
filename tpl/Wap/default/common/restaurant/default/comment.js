function comment() {
	this.config = {
		...
		styleUrl: './tpl/Wap/default/common/restaurant/default/comment.css'
	};
	...
	this.display = function() {
		...
		html += '<link rel="stylesheet" type="text/css" href="./tpl/Wap/default/common/restaurant/default/vlink.reply.css">';
		html += '<script src="./tpl/Wap/default/common/restaurant/default/swipe.js"></script>';
		html += '<script src="./tpl/Wap/default/common/restaurant/default/vlink.reply.js"></script>';
	...
	this.post = function(content) {
		...
		$.iBox.loading("数据保存中...");
		$.post(
				this.config['postCommentUrl'], {item: this.config['item'], pid: this.config['item_id'], mpid: this.config['mpid'], mid: member_id, content: content},
		function(json) {
			if (json.status == 0) {
	...
	this.get = function() {
		...
		$.get(this.config['getCommentUrl'], {token: this.config['token'], item: this.config['item'], pid: this.config['item_id'], page: this.config['page'], mpid: this.config['mpid']},
		function(json) {
			$.iBox.close();
