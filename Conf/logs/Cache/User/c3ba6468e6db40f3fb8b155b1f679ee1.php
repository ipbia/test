...
</script><?php endif; ?><link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" /><div class="content"><div class="cLineB"><h4 class="left">商品管理(<?php echo ($page); ?>)</h4><div class="clr"></div></div><!--tab start--><div class="tab"><ul><?php if($isgroup != 1 OR $ischild != 1): ?><li class="tabli" id="tab2"><a href="<?php echo U('Store/index',array('token'=>$token));?>">商品分类管理</a></li><li class="current tabli" id="tab0"><a href="<?php echo U('Store/product',array('token'=>$token, 'catid'=>$catid));?>">商品管理</a></li><li class="tabli" id="tab2"><a href="<?php echo U('Store/orders',array('token'=>$token));?>">订单管理</a></li><?php if($ischild == 0): ?><li class="tabli" id="tab5"><a href="<?php echo U('Reply_info/set',array('token'=>$token,'infotype'=>'Shop'));?>">商城回复配置</a></li><?php endif; if($isgroup == 1): ?><li class="tabli" id="tab5"><a href="<?php echo U('Store/group',array('token'=>$token));?>">商品分组</a></li><li class="tabli" id="tab7"><a href="<?php echo U('Store/productgroup',array('token'=>$token));?>">分组商品展现</a></li><?php endif; else: ?><li class="tabli" id="tab2"><a href="<?php echo U('Store/orders',array('token'=>$token));?>">订单管理</a></li><?php endif; ?><li class="tabli" id="tab2"><a href="<?php echo U('Store/flash',array('token'=>$token));?>">商城背景与轮播图</a></li><li class="tabli" id="tab8"><a href="<?php echo U('Store/twitter',array('token'=>$token));?>">商城分佣管理</a></li></ul></div><!--tab end--><div class="cLine"><?php if($catid != 0): ?><div class="pageNavigator left"><a href="<?php echo U('Store/addNew', array('token' => $token, 'catid' => $catid));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加商品</a></div><?php endif; ?><div class="pageNavigator right"><a href="<?php echo U('Store/index',array('token'=>$token,'catid'=>$catid));?>" class="btnGrayS vm bigbtn">返回</a></div><div class="clr"></div></div><div class="msgWrap"><form method="post" action="" id="info"><input name="delall" type="hidden" value=""><input name="wxid" type="hidden" value=""><table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%"><thead><tr><th class="select">选择</th><th width="160">商品名称</th><th width="60">价格</th><th width="60">会员价</th><th width="60">销量</th><th width="170">关键词</th><th width="200">创建时间</th><th width="150" class="norightborder">操作</th></tr></thead><tbody><tr></tr><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><tr><td><input type="checkbox" name="del_id[<?php echo ($i); ?>]" value="285" class="checkitem"></td><td><?php echo ($hostlist["name"]); ?></td><td><?php echo ($hostlist["price"]); ?>元</td><td><?php echo ($hostlist["vprice"]); ?>元</td><td><?php echo ($hostlist["salecount"]); ?></td><td><?php echo ($hostlist["keyword"]); ?></td><td><?php echo (date("Y-m-d H:i:s",$hostlist["time"])); ?></td><td class="norightborder" align="center"><a href="<?php echo U('Store/addNew',array('id' => $hostlist['id'], 'token' => $token,'catid' => $catid));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Store/del',array('id'=>$hostlist['id'],'token'=>$token,'catid'=>$catid));?>');">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="<?php echo U('Store/comment', array('pid'=>$hostlist['id'],'token'=>$token,'catid'=>$catid));?>">用户评论</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></tbody></table></form></div><div class="cLine"><div class="pageNavigator right"><div class="pages"><?php echo ($page); ?></div></div><div class="clr"></div></div></div></div></div></div><style>.IndexFoot {
